    ...
    <div class="fixed bottom-5 right-5 z-50">
      ...
      >
        <Show when={state.open}>
          <div
            class="relative h-[240px] w-[192px] rounded-[8px] bg-v2-background-bg-base p-1 shadow-[var(--v2-elevation-floating)]"
            aria-label="Introducing Tabs. A faster, more intuitive way to work."
          >
            <button
              type="button"
              aria-label="Close"
              class="absolute top-3 right-3 z-10 flex size-5 items-center justify-center rounded-[4px] bg-[rgba(0,0,0,0.4)]"
              onClick={(event) => {
            ...
            <div class="relative block h-[232px] w-[184px] overflow-hidden rounded-[4px] bg-[#060606] text-left">
              <div class="absolute inset-0 bg-[radial-gradient(circle_at_28%_16%,rgba(255,255,255,0.38),transparent_22%),radial-gradient(circle_at_76%_34%,rgba(255,255,255,0.18),transparent_24%),linear-gradient(135deg,#151515_0%,#0A0A0A_44%,#000000_100%)]" />
              <div class="absolute left-5 right-5 top-8 flex flex-col gap-2">
                <div class="h-2 rounded-full bg-white/35" />
                <div class="h-2 w-3/4 rounded-full bg-white/20" />
                <div class="mt-3 grid grid-cols-3 gap-1.5">
                  <div class="h-12 rounded-[3px] bg-white/15" />
                  <div class="h-12 rounded-[3px] bg-white/25" />
                  <div class="h-12 rounded-[3px] bg-white/10" />
                </div>
              </div>
              <div class="absolute inset-x-0 bottom-0 flex w-full flex-col items-start gap-1.5 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,#000000_100%)] px-3 py-5">
                <p class="w-full cursor-default select-none text-[13px] font-[530] leading-none tracking-[-0.04px] text-[#FFFFFF]">
                  Introducing Tabs
                </p>
